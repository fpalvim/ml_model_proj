...
class BoxplotVisualizer:
    """
    A class for generating boxplots of numeric columns in a pandas DataFrame.
    """

    def __init__(self, df):
        """
        Initializes the BoxplotVisualizer with a DataFrame.
    ...
    def generate_boxplots(self):
        """
        Generates and displays boxplots for all numeric columns.
        """
        if not self.numeric_columns:
            print("No numeric columns found in the DataFrame.")
            return

        num_cols = len(self.numeric_columns)
        rows = (num_cols + 2) // 3  # Calculate rows, adjust as needed

        plt.figure(figsize=(12, 5 * rows))  # Adjust figure size as needed
...
class ColumnsPlotter:
    """
    A class to generate histplots for numeric columns and countplots for categorical columns.
    """

    def __init__(self, df):
        """
        Initializes the ColumnPlotter with a DataFrame.
    ...
    def generate_plots(self):
        """
        Generates and displays histplots and countplots for the DataFrame's columns.
        """
        ...
        if total_plots == 0:
            print("No numeric or categorical columns found in the DataFrame.")
            return

        rows = (total_plots + 2) // 3  # Calculate rows, adjust as needed
